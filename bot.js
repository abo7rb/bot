...
setInterval(() => {
  http.get(`http://arab-mafia.glitch.me/`);
}, 280000);
...
const dev = ["624861692399976449"]; ///تعديل مهم حط ايدي حسابك
const admin = "=";
var owner = "624861692399976449"; // Owner Bot Mention /// تعديل مهم حط ايدي حسابكتعديل مهم ايدي حسابك
...
client.on("ready", () => {
  ...
  console.log(`ALHarbi`);
  console.log(`----------------`);
  console.log(`ON ${client.guilds.size} Servers '     Script By : !ALHarbi  `);
  console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setActivity("Arab Mafia @!ALHarbi" ); ///تعديل مهم غير كلمة هيلب وبرميوم اللي بدك اياه مثل اسم سيرفرك
...
client.on("message", zaid => {
  if (zaid.content === "=bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@589463003293024256>`, true) // تعديل مهم عدل هذا الرقم لايدي حسابك
      .setImage(
        ""
      )
...
let room = "698835770420625448"; //تعديل مهم ايدي روم عد الاعضاء والترحيب ، روم صوتي
